        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl font-bold tracking-tighter text-white mb-6 max-w-5xl leading-[0.95]">
             Construis des systèmes automatisés, <span className="bg-clip-text text-transparent bg-gradient-to-b from-white via-white/80 to-white/40">monétise ton expertise.</span>
            </motion.h1>
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-3 mb-10">
              {[
                ...
                { icon: <Layers size={14} />, label: "Workflows complets" },
              ].map((token, idx) => (
        ...
        <div className="relative rounded-[40px] border border-white/10 bg-[#080910] p-10 md:p-20 overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { icon: <Database className="text-purple-400" />, title: "Agents IA", desc: "Brique essentielle" },
                  { icon: <Terminal className="text-cyan-400" />, title: "Logique métier", desc: "Pensé pour le terrain" },
            ...
            <div className="order-1 lg:order-2">
              <span className="text-indigo-500 font-bold uppercase tracking-[0.4em] text-[10px] mb-4 block">Des bases à l'expertise.</span>
              <h3 className="text-4xl md:text-5xl font-bold mb-6 leading-tight tracking-tight">Focalisé sur l'exécution <br /></h3>
              <p className="text-gray-400 text-lg leading-relaxed font-light mb-8">
                Grâce à un <strong>apprentissage guidé étape par étape</strong>, vous maîtriserez rapidement la création d'agents intelligents et serez en mesure de <strong>générer vos premiers revenus</strong> en proposant vos services d'automatisation.
              </p>
