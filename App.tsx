        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl font-bold tracking-tighter text-white mb-6 max-w-5xl leading-[0.95]">
             Maîtrise n8nConstruis des systèmes automatisés, monétise ton expertise. <span className="bg-clip-text text-transparent bg-gradient-to-b from-white via-white/80 to-white/40">avec une vraie compréhension de l'IA.</span>
            </motion.h1>
